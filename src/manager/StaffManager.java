...
//    Tính lương nhân viên
    ...
    //    Sửa thông tin
    public void editInformation(List<Staff> arr, String name) throws Exception {
        try {
            for (int i = 0; i < arr.size(); i++) {
                if (arr.get(i) instanceof FullTimeStaff &&
                    ...
                    switch (check) {
                        ...
                        case 6:
                            ...
                            System.out.println(((FullTimeStaff) arr.get(i)).getWorkingDay());
                        ...
                        case 7:
                            ...
                            System.out.println(((FullTimeStaff) arr.get(i)).getSeniority());
                    ...
                    switch (check1) {
                        ...
                        case 6:
                            ...
                            System.out.println(((PartTime) arr.get(i)).getTime());
                        ...
                        case 7:
                            ...
                            System.out.println(((PartTime) arr.get(i)).getFines());
                            System.out.println("Nhập tiền vi phạm mới: ");
                            int fines = scanner1.nextInt();
                            ((PartTime) arr.get(i)).setFines(fines);
                            return;
                    }
                    ...
                    switch (check2) {
                        ...
                        case 5:
                            ...
                            break;
                        case 6:
                            System.out.println("Tên bộ phận cũ: ");
                            System.out.println(((HeadOfDepartment) arr.get(i)).getPart());
                            System.out.println("Nhập tên bộ phận mới: ");
                            String part = scannerz.nextLine();
                            ((HeadOfDepartment) arr.get(i)).setPart(part);
                            break;
                        case 7:
                            System.out.println("Tiền lương cứng cũ: ");
                            System.out.println(((HeadOfDepartment) arr.get(i)).getHardSalary());
                            System.out.println("Nhập lương cứng mới: ");
                            int hardSalary = scanner2.nextInt();
                            ((HeadOfDepartment) arr.get(i)).setHardSalary(hardSalary);
                            break;
                        case 8:
                            System.out.println("Cấp độ trách nhiệm cũ: ");
                            System.out.println(((HeadOfDepartment) arr.get(i)).getRank());
